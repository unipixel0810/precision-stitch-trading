...
- `lib/infrastructure/persistence/*` — 마지막 성공 번들 로컬 캐시(`shared_preferences`, TTL·`dashboard_cache_ttl.dart`).
...
- Infra: `test/infrastructure/shared_preferences_dashboard_bundle_cache_test.dart` — 캐시 TTL.
